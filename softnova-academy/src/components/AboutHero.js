  ...
  return (
    <section className={styles.hero}>
      <div className={styles.heroCard}>
        ...
        <div className={styles.heroMiniBoxes}>
          <div className={styles.heroMiniBox}><Code size={24} /></div>
          <div className={styles.heroMiniBox}><Cpu size={24} /></div>
          <div className={styles.heroMiniBox}><Layers size={24} /></div>
        </div>
